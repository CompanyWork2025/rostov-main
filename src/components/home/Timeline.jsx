  ...
  return (
    <div className="bg-gray-800 flex flex-col lg:flex-row items-center justify-center px-6 py-10">
      ...
      <div className="flex-1 relative w-full max-w-4xl">
        ...
        {/* Vertical Line */}
        <div className="hidden lg:block absolute left-[40px] transform translate-x-1/2 bg-red-500 h-full w-1"></div>

        {/* Timeline Steps */}
        <div className="space-y-12 relative">
          {/* Step 1 */}
          <div className="flex flex-col lg:flex-row items-center lg:items-center relative">
            <div className="lg:absolute left-[40px] transform lg:-translate-x-1/2 w-10 h-10 rounded-full bg-red-500 border-4 border-gray-800 text-white flex items-center justify-center text-lg font-bold mb-4 lg:mb-0">
              1
            </div>
            <div className="lg:ml-16 text-center lg:text-left w-full lg:w-2/3">
